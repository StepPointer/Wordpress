...
final class Themify_Builder_Model {
	...
	static public function find_layout_updates() {
		return version_compare( THEMIFY_BUILDER_LAYOUTS_VERSION, self::get_current_layouts_version(), '>' );
	}
	 ...
	 *
	 * @since 1.5.4 Check if it's a Themify theme or not. If it's not, it's Builder standalone plugin.
	 *
	 * @return boolean
	 */
