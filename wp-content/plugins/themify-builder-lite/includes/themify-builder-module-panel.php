	...
	<div id="themify_builder_module_panel" class="themify_builder_module_panel clearfix">
		...
		<div class="slide_builder_module_panel_wrapper">
			...
			<?php $class = "themify_builder_module module-type-{$module->slug}"; 
                            if(isset(Themify_Builder::$premium_modules[$module->slug])){
                                $class.=' themify_is_premium_module';
                            }
                        ?>
			...
			<div class="<?php echo esc_attr($class); ?>" data-module-name="<?php echo esc_attr( $module->slug ); ?>">
				<strong class="module_name"><?php echo esc_html( $module->name ); ?></strong>
                                <?php if(!isset(Themify_Builder::$premium_modules[$module->slug])):?>
			...
			<div class="builder_save_front_panel">
				...
				<div class="themify-builder-front-save">
					...
					<div class="themify-builder-revision-dropdown-panel">
							...
							<ul>
                                                                <li><a href="#" class="<?php echo $is_premium?'js-themify-builder-save-revision':'themify_builder_lite'?>"><?php esc_html_e( 'Save as Revision', 'themify' ); ?></a></li>
                                                            <li><a href="#" class="<?php echo $is_premium?'js-themify-builder-load-revision':'themify_builder_lite'?>"><?php esc_html_e( 'Load Revision', 'themify' ); ?></a></li>
							</ul>
					</div>
				</div>
			</div>
